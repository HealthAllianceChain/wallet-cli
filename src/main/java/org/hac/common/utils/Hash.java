...
import static org.hac.common.utils.ByteUtil.*;
...
public class Hash {
  ...
  static {
    Security.addProvider(hacCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("SC");
    HASH_256_ALGORITHM_NAME = "hac-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "hac-KECCAK-512";
