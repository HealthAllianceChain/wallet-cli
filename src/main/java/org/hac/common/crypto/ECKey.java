...
import org.hac.common.crypto.cryptohash.Keccak256;
import org.hac.common.crypto.jce.*;
import org.hac.common.utils.BIUtil;
import org.hac.common.utils.ByteUtil;
import org.hac.common.utils.Hash;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(hacCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = hacCastleProvider.getInstance();
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(hacCastleProvider.getInstance(), privateKeyFromBigInteger(priv), pub);
  }
