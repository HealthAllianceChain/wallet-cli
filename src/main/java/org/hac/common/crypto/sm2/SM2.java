package org.hac.common.crypto.sm2;
...
import org.hac.common.crypto.jce.ECKeyFactory;
import org.hac.common.crypto.jce.hacCastleProvider;
...
import static org.hac.common.utils.BIUtil.isLessThan;
import static org.hac.common.utils.ByteUtil.bigIntegerToBytes;
import static org.hac.common.utils.Hash.computeAddress;
...
public class SM2 implements Serializable, SignInterface {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory.getInstance(hacCastleProvider.getInstance())
