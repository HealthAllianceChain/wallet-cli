...
public class CheckStrength {
  ...
  public enum LEVEL {
    EASY, MIDIUM, ShacG, VERY_ShacG, EXTREMELY_ShacG
  }
  ...
  /**
   * Get password strength level, includes easy, midium, shacg, very shacg, extremely shacg
   */
  public static LEVEL getPasswordLevel(char[] passwd) {
    ...
    switch (level) {
      ...
      case 11:
      case 12:
        return LEVEL.VERY_ShacG;
      default:
        return LEVEL.EXTREMELY_ShacG;
    }
  }
