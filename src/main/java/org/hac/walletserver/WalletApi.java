...
import org.hac.api.GrpcAPI;
import org.hac.api.GrpcAPI.AccountNetMessage;
import org.hac.api.GrpcAPI.AccountResourceMessage;
import org.hac.api.GrpcAPI.AddressPrKeyPairMessage;
import org.hac.api.GrpcAPI.AssetIssueList;
import org.hac.api.GrpcAPI.BlockExtention;
import org.hac.api.GrpcAPI.BlockList;
import org.hac.api.GrpcAPI.BlockListExtention;
import org.hac.api.GrpcAPI.BytesMessage;
import org.hac.api.GrpcAPI.DecryptNotes;
import org.hac.api.GrpcAPI.DecryptNotesMarked;
import org.hac.api.GrpcAPI.DelegatedResourceList;
import org.hac.api.GrpcAPI.DiversifierMessage;
import org.hac.api.GrpcAPI.EasyTransferResponse;
import org.hac.api.GrpcAPI.EmptyMessage;
import org.hac.api.GrpcAPI.ExchangeList;
...
import org.hac.api.GrpcAPI.IvkDecryptAndMarkParameters;
import org.hac.api.GrpcAPI.IvkDecryptParameters;
import org.hac.api.GrpcAPI.NfParameters;
import org.hac.api.GrpcAPI.NodeList;
import org.hac.api.GrpcAPI.NoteParameters;
import org.hac.api.GrpcAPI.OvkDecryptParameters;
import org.hac.api.GrpcAPI.PaymentAddressMessage;
import org.hac.api.GrpcAPI.PrivateParameters;
import org.hac.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.hac.api.GrpcAPI.ProposalList;
import org.hac.api.GrpcAPI.Return;
import org.hac.api.GrpcAPI.SpendAuthSigParameters;
import org.hac.api.GrpcAPI.SpendResult;
import org.hac.api.GrpcAPI.TransactionApprovedList;
import org.hac.api.GrpcAPI.TransactionExtention;
import org.hac.api.GrpcAPI.TransactionInfoList;
import org.hac.api.GrpcAPI.TransactionList;
import org.hac.api.GrpcAPI.TransactionListExtention;
import org.hac.api.GrpcAPI.TransactionSignWeight;
import org.hac.api.GrpcAPI.TransactionSignWeight.Result.response_code;
import org.hac.api.GrpcAPI.ViewingKeyMessage;
import org.hac.api.GrpcAPI.WitnessList;
import org.hac.common.crypto.ECKey;
import org.hac.common.crypto.Hash;
import org.hac.common.crypto.Sha256Sm3Hash;
import org.hac.common.crypto.sm2.SM2;
import org.hac.common.utils.Base58;
import org.hac.common.utils.ByteArray;
import org.hac.common.utils.TransactionUtils;
import org.hac.common.utils.Utils;
import org.hac.core.config.Configuration;
import org.hac.core.config.Parameter.CommonConstant;
import org.hac.core.exception.CancelException;
import org.hac.core.exception.CipherException;
import org.hac.protos.Protocol.Transaction.Contract.ContractType;
import org.hac.protos.Protocol.Transaction.Result;
import org.hac.keystore.CheckStrength;
import org.hac.keystore.Credentials;
import org.hac.keystore.Wallet;
import org.hac.keystore.WalletFile;
import org.hac.keystore.WalletUtils;
import org.hac.protos.contract.AccountContract.AccountCreateContract;
import org.hac.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.hac.protos.contract.AccountContract.AccountUpdateContract;
import org.hac.protos.contract.AccountContract.SetAccountIdContract;
import org.hac.protos.contract.AssetIssueContractOuterClass.AssetIssueContract;
import org.hac.protos.contract.AssetIssueContractOuterClass.ParticipateAssetIssueContract;
import org.hac.protos.contract.AssetIssueContractOuterClass.TransferAssetContract;
import org.hac.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.hac.protos.contract.BalanceContract.TransferContract;
import org.hac.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.hac.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.hac.protos.contract.ExchangeContract.ExchangeTransactionContract;
import org.hac.protos.contract.ExchangeContract.ExchangeWithdrawContract;
import org.hac.protos.contract.ProposalContract.ProposalApproveContract;
import org.hac.protos.contract.ProposalContract.ProposalCreateContract;
import org.hac.protos.contract.ProposalContract.ProposalDeleteContract;
import org.hac.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.hac.protos.contract.ShieldContract.OutputPointInfo;
import org.hac.protos.contract.ShieldContract.ShieldedTransferContract;
import org.hac.protos.contract.ShieldContract.SpendDescription;
import org.hac.protos.contract.SmartContractOuterClass.TriggerSmartContract;
import org.hac.protos.contract.StorageContract.BuyStorageBytesContract;
import org.hac.protos.contract.StorageContract.BuyStorageContract;
import org.hac.protos.contract.SmartContractOuterClass.ClearABIContract;
import org.hac.protos.contract.SmartContractOuterClass.CreateSmartContract;
import org.hac.protos.contract.BalanceContract.FreezeBalanceContract;
import org.hac.protos.contract.StorageContract.SellStorageContract;
import org.hac.protos.contract.AssetIssueContractOuterClass.UnfreezeAssetContract;
import org.hac.protos.contract.BalanceContract.UnfreezeBalanceContract;
import org.hac.protos.contract.StorageContract.UpdateBrokerageContract;
import org.hac.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
import org.hac.protos.contract.SmartContractOuterClass.UpdateSettingContract;
import org.hac.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.hac.protos.Protocol.Account;
import org.hac.protos.Protocol.Block;
import org.hac.protos.Protocol.ChainParameters;
import org.hac.protos.Protocol.DelegatedResourceAccountIndex;
import org.hac.protos.Protocol.Exchange;
import org.hac.protos.Protocol.Key;
import org.hac.protos.Protocol.Permission;
import org.hac.protos.Protocol.Proposal;
import org.hac.protos.contract.SmartContractOuterClass.SmartContract;
import org.hac.protos.Protocol.Transaction;
import org.hac.protos.Protocol.TransactionInfo;
import org.hac.protos.Protocol.TransactionSign;
import org.hac.protos.Protocol.Witness;
import org.hac.protos.contract.WitnessContract.VoteWitnessContract;
import org.hac.protos.contract.WitnessContract.WitnessCreateContract;
import org.hac.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class WalletApi {
  ...
  private Transaction signTransaction(Transaction transaction)
    ...
    while (true) {
      ...
      byte[] passwd = org.hac.keystore.StringUtils.char2Byte(password);
      org.hac.keystore.StringUtils.clear(password);
      if (isEckey) {
      ...
      org.hac.keystore.StringUtils.clear(passwd);
