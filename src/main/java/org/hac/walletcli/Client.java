...
import org.hac.common.utils.AbiUtil;
import org.hac.common.utils.ByteArray;
import org.hac.common.utils.ByteUtil;
...
import org.hac.core.exception.EncodingException;
import org.hac.core.exception.ZksnarkException;
import org.hac.core.zen.ShieldedAddressInfo;
import org.hac.core.zen.ShieldedNoteInfo;
import org.hac.core.zen.ShieldedWrapper;
import org.hac.core.zen.ZenUtils;
import org.hac.core.zen.address.KeyIo;
import org.hac.core.zen.address.PaymentAddress;
...
public class Client {
  ...
  private void assetIssue(String[] parameters)
    ...
    if (parameters == null || parameters.length < 12) {
      ...
      System.out
          .println(
              "TrxNum and AssetNum represents the conversion ratio of the hac to the asset.");
      System.out
...
//          "Note: Please append the param for constructor tightly with byteCode without any space");
  ...
  private void help() {
    System.out.println("Help: List of hac Wallet-cli commands");
    System.out.println(
  ...
  private void run() {
    System.out.println(" ");
    System.out.println("Welcome to hac Wallet-Cli");
