...
public class Test {
  ...
  public static Transaction createTransactionEx(String toAddress, long amount) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      ByteString bsOwner = ByteString.copyFrom(ByteArray
          .fromHexString("e1a17233ccf16d6b12dcc074ca1152477ccf9b84"));
  ...
  public static void testVerify() {
    ...
    String sign =
        "2D89243F93670AA2F209FD1E0BDACA67E327B78FA54D728628F4EBBF6B7917E5BB0642717EC2234D21BEFAA7577D5FC6B4D47C94F2C0618862CD4C9E3C839C464";
    ECKey eCkey = null;
  ...
  public static void testGenKey() {
    ECKey eCkey = null;
    String priKeyHex = "aba92a516ea09f620a16ff7ee95ce0df1d56550a8babe9964981a7144c8a784a";
    try {
